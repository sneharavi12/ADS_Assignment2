import luigi
from Classes.RejectLoanData.CleanData import CleanData
import pandas as pd
...
class Start(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget("Data/Results/resultsrejectloandata.csv")
...
if __name__ == '__main__':
    try:
        os.remove("Data/Results/resultsrejectloandata.csv")
    except:
        pass
    luigi.run()