...
class GetData(luigi.Task):
    ...
    def output(self):
        return { 'output1' : luigi.LocalTarget("Data/Downloads/DeclinedLoanData/RejectStatsA.csv"),\
        'output2' : luigi.LocalTarget("Data/Downloads/DeclinedLoanData/RejectStatsB.csv"),\
        'output3' : luigi.LocalTarget("Data/Downloads/DeclinedLoanData/RejectStatsD.csv"),\
        'output4' : luigi.LocalTarget("Data/Downloads/DeclinedLoanData/RejectStats_2016Q1.csv"),\
        'output5' : luigi.LocalTarget("Data/Downloads/DeclinedLoanData/RejectStats_2016Q2.csv"),\
        'output6' : luigi.LocalTarget("Data/Downloads/DeclinedLoanData/RejectStats_2016Q3.csv"),\
        'output7' : luigi.LocalTarget("Data/Downloads/DeclinedLoanData/RejectStats_2016Q4.csv") }
